...
class VapaamuotoinenSuoritusResource
  ...
  extends HakurekisteriResource[Suoritus, CreateVapaamuotoinenSuoritusCommand](suoritusRekisteriActor, SuoritusQuery(_)) with VapaamuotoinenSuoritusSwaggerApi with HakurekisteriCrudCommands[Suoritus, CreateVapaamuotoinenSuoritusCommand] with SecuritySupport with IncidentReporting{
